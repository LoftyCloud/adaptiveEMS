...
path = 'E:\documents\DRLResult2\data\DCdata2.mat'

import scipy.io as scio
cycmps_data=scio.loadmat(path)
cycmps_data = cycmps_data['data'][0]
...
data_split = []
step_len = 30
for i in range(1, len(cycmps_data) - 90, step_len):
    data = cycmps_data[i:i + 90]
    data_split.append(data)
print(len(data_split))
# print(data_split.shape)
# data_split.append(cycmps_data[len(cycmps_data) - 90:len(cycmps_data)])

# print(len(data_split))
# print(len(data_split[0]))
# print(data_split[0])
